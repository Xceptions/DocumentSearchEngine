...
class DocumentSearch:
    ...
    def save_document(self, document:str, document_id:str) -> str:
        """ 
            ...
            Args:
                ...
                object_id(str) - a string generated by the flask app for storing as the
                    id of the document(MongoDB)
            Returns
                List[str]: the list of documents(str)
        """
    ...
    def save_words(
        ...
        """ 
            ...
            We don't need to manually generate / pass in an object id as we
            do for the `save_document` method. We leave that to pymongo
            The function performs the following steps:
                - receives a document(str), and a document_id input
                    from the add_document_to_db in the `app.py`
                - converts the document(str) to a list of lowercase words
                    called `words`
                - uses the self.db to retrieve the documents(MongoDB) that
    ...
    def search_for_word(self, user_input: str) -> List[str]:
        ...
        all_occurrences_id = [str(id) for id in set(all_occurrences)]
